...
- Rank every genuinely new comic selection only by the sum of its distinct exact-card priorities. The unread comic with the largest sum wins; use comic ID only as a deterministic tie-breaker.
